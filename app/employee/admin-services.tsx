...
export default function OwnerServicesScreen() {
  ...
  const loadServices = async () => {
    try {
      if (!user?.employeeBarbershopId) return;

      const data = await getServices(user.employeeBarbershopId);
      setServices(data);
    } catch (error) {
        ...
        <View style={styles.container}>
          ...
          <View style={styles.header}>
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                router.push("/employee/admin-services-create" as any)
              }
              activeOpacity={0.85}
            >
              <LinearGradient
              ...
              <View style={styles.serviceCard}>
                ...
                <View style={styles.actionsRow}>
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      router.push(
                        `/employee/admin-services-edit/${item.id}` as any,
                      )
                    }
                    activeOpacity={0.85}
                  >
