...
export default function EmployeeAdminProductsScreen() {
      ...
      <FlatList
        ...
        ListHeaderComponent={
          <View>
            ...
            <Text style={styles.badge}>ADMIN PRODUCTOS</Text>
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                router.push("/employee/admin-products-create" as any)
              }
              activeOpacity={0.85}
            >
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                router.push("/employee/admin-product-sales" as any)
              }
              activeOpacity={0.85}
            >
        ...
        ListEmptyComponent={
          <View style={styles.emptyCard}>
            ...
            <Text style={styles.emptyText}>
              Crea el primer producto para manejar inventario.
            </Text>
          </View>
        }
        renderItem={({ item }) => {
          ...
          return (
            <View style={styles.productCard}>
              ...
              <View
                style={[
                  styles.stockBox,
                  lowStock && styles.lowStockBox,
                  outStock && styles.outStockBox,
                ]}
              >
                ...
                {outStock && <Text style={styles.outStockText}>Agotado</Text>}
              </View>
              ...
              <View style={styles.actionsRow}>
                <TouchableOpacity
                  ...
                  onPress={() =>
                    router.push(
                      `/employee/admin-products-stock/${item.id}` as any,
                    )
                  }
                  activeOpacity={0.85}
                >
                ...
                <TouchableOpacity
                  ...
                  onPress={() =>
                    router.push(
                      `/employee/admin-products-edit/${item.id}` as any,
                    )
                  }
                  activeOpacity={0.85}
                >
...
const styles = StyleSheet.create({
  ...
  lowStockBox: { backgroundColor: "#FEF3C7" },
  outStockBox: { backgroundColor: "#FEE2E2" },
  stockLabel: {
    fontSize: 13,
    color: "#6B7280",
    fontWeight: "700",
